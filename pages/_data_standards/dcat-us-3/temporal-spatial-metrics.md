...
## <a name="period-of-time--anyOf_i0"></a>Property `PeriodOfTime > anyOf > item 0`
...
## <a name="period-of-time--anyOf_i1"></a>Property `PeriodOfTime > anyOf > item 1`
...
## <a name="period-of-time--@id"></a>[Optional] Property `PeriodOfTime > @id`
...
## <a name="period-of-time--@type"></a>[Optional] Property `PeriodOfTime > @type`
...
## <a name="period-of-time--endDate"></a>[Optional] Property `PeriodOfTime > endDate`
...
### <a name="period-of-time--endDate_anyOf_i0"></a>Property `PeriodOfTime > endDate > anyOf > Null allowed when not required`
...
### <a name="period-of-time--endDate_anyOf_i1"></a>Property `PeriodOfTime > endDate > anyOf > item 1`
...
#### <a name="period-of-time--endDate_anyOf_i1_anyOf_i0"></a>Property `PeriodOfTime > endDate > anyOf > item 1 > anyOf > item 0`

| **Type**   | `string`    |
| ---------- | ----------- |
| **Format** | `date-time` |

#### <a name="period-of-time--endDate_anyOf_i1_anyOf_i1"></a>Property `PeriodOfTime > endDate > anyOf > item 1 > anyOf > item 1`

| **Type**   | `string` |
| ---------- | -------- |
| **Format** | `date`   |

#### <a name="period-of-time--endDate_anyOf_i1_anyOf_i2"></a>Property `PeriodOfTime > endDate > anyOf > item 1 > anyOf > item 2`
...
#### <a name="period-of-time--endDate_anyOf_i1_anyOf_i3"></a>Property `PeriodOfTime > endDate > anyOf > item 1 > anyOf > item 3`
...
## <a name="period-of-time--startDate"></a>[Optional] Property `PeriodOfTime > startDate`
...
### <a name="period-of-time--startDate_anyOf_i0"></a>Property `PeriodOfTime > startDate > anyOf > Null allowed when not required`
...
### <a name="period-of-time--startDate_anyOf_i1"></a>Property `PeriodOfTime > startDate > anyOf > item 1`
...
#### <a name="period-of-time--startDate_anyOf_i1_anyOf_i0"></a>Property `PeriodOfTime > startDate > anyOf > item 1 > anyOf > item 0`

| **Type**   | `string`    |
| ---------- | ----------- |
| **Format** | `date-time` |

#### <a name="period-of-time--startDate_anyOf_i1_anyOf_i1"></a>Property `PeriodOfTime > startDate > anyOf > item 1 > anyOf > item 1`

| **Type**   | `string` |
| ---------- | -------- |
| **Format** | `date`   |

#### <a name="period-of-time--startDate_anyOf_i1_anyOf_i2"></a>Property `PeriodOfTime > startDate > anyOf > item 1 > anyOf > item 2`
...
#### <a name="period-of-time--startDate_anyOf_i1_anyOf_i3"></a>Property `PeriodOfTime > startDate > anyOf > item 1 > anyOf > item 3`
...
## <a name="location--@id"></a>[Optional] Property `Location > @id`
...
## <a name="location--@type"></a>[Optional] Property `Location > @type`
...
## <a name="location--bbox"></a>[Optional] Property `Location > bbox`
...
### <a name="location--bbox_anyOf_i0"></a>Property `Location > bbox > anyOf > item 0`

| **Type** | `null` |
| -------- | ------ |

### <a name="location--bbox_anyOf_i1"></a>Property `Location > bbox > anyOf > item 1`
...
### <a name="location--bbox_anyOf_i2"></a>Property `Location > bbox > anyOf > item 2`
...
#### <a name="location--bbox_anyOf_i2_coordinates"></a>Property `Location > bbox > anyOf > item 2 > coordinates`
...
#### <a name="location--bbox_anyOf_i2_type"></a>Property `Location > bbox > anyOf > item 2 > type`
...
## <a name="location--centroid"></a>[Optional] Property `Location > centroid`
...
### <a name="location--centroid_anyOf_i0"></a>Property `Location > centroid > anyOf > item 0`

| **Type** | `null` |
| -------- | ------ |

### <a name="location--centroid_anyOf_i1"></a>Property `Location > centroid > anyOf > item 1`
...
### <a name="location--centroid_anyOf_i2"></a>Property `Location > centroid > anyOf > item 2`
...
#### <a name="location--centroid_anyOf_i2_coordinates"></a>Property `Location > centroid > anyOf > item 2 > coordinates`
...
##### <a name="location--centroid_anyOf_i2_coordinates_items"></a>Location > centroid > anyOf > item 2 > coordinates > coordinates items

| **Type** | `number` |
| -------- | -------- |

#### <a name="location--centroid_anyOf_i2_type"></a>Property `Location > centroid > anyOf > item 2 > type`
...
## <a name="location--identifier"></a>[Optional] Property `Location > identifier`
...
### <a name="location--identifier_anyOf_i0"></a>Property `Location > identifier > anyOf > item 0`

| **Type** | `null` |
| -------- | ------ |

### <a name="location--identifier_anyOf_i1"></a>Property `Location > identifier > anyOf > Identifier`
...
### <a name="location--geometry_anyOf_i0"></a>Property `Location > geometry > anyOf > item 0`

| **Type** | `null` |
| -------- | ------ |

### <a name="location--geometry_anyOf_i1"></a>Property `Location > geometry > anyOf > item 1`
...
### <a name="location--geometry_anyOf_i2"></a>Property `Location > geometry > anyOf > item 2`
...
## <a name="location--inScheme"></a>[Optional] Property `Location > inScheme`
...
### <a name="location--inScheme_anyOf_i0"></a>Property `Location > inScheme > anyOf > item 0`

| **Type** | `null` |
| -------- | ------ |

### <a name="location--inScheme_anyOf_i1"></a>Property `Location > inScheme > anyOf > ConceptScheme`
...
## <a name="location--prefLabel"></a>[Optional] Property `Location > prefLabel`
...
## <a name="metric--@id"></a>[Optional] Property `Metric > @id`
...
## <a name="metric--@type"></a>[Optional] Property `Metric > @type`
...
## <a name="metric--expectedDataType"></a>[Optional] Property `Metric > expectedDataType`
...
## <a name="metric--inDimension"></a>[Optional] Property `Metric > inDimension`
...
## <a name="metric--definition"></a>[Optional] Property `Metric > definition`
...
## <a name="quality-measurement--@id"></a>[Optional] Property `QualityMeasurement > @id`
...
## <a name="quality-measurement--@type"></a>[Optional] Property `QualityMeasurement > @type`
...
## <a name="quality-measurement--isMeasurementOf"></a>[Optional] Property `QualityMeasurement > isMeasurementOf`
...
## <a name="quality-measurement--unitMeasure"></a>[Optional] Property `QualityMeasurement > unitMeasure`
...
## <a name="activity--@id"></a>[Optional] Property `Activity > @id`
...
## <a name="activity--@type"></a>[Optional] Property `Activity > @type`
...
## <a name="activity--category"></a>[Optional] Property `Activity > category`
...
## <a name="address--@id"></a>[Optional] Property `Address > @id`
...
## <a name="address--@type"></a>[Optional] Property `Address > @type`
...
## <a name="address--country-name"></a>[Optional] Property `Address > country-name`
...
## <a name="address--locality"></a>[Optional] Property `Address > locality`
...
## <a name="address--postal-code"></a>[Optional] Property `Address > postal-code`
...
## <a name="address--region"></a>[Optional] Property `Address > region`
...
## <a name="address--street-address"></a>[Optional] Property `Address > street-address`
