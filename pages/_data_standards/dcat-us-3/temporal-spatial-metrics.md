...
## <a name="period-of-time--anyOf_i0"></a>`PeriodOfTime > anyOf > item 0` [#](#period-of-time--anyOf_i0)

- **Type**: `object`
- **Additional properties**: Any type allowed

### <a name="period-of-time--autogenerated_heading_2"></a>The following properties are required [#](#period-of-time--autogenerated_heading_2)
* startDate

## <a name="period-of-time--anyOf_i1"></a>`PeriodOfTime > anyOf > item 1` [#](#period-of-time--anyOf_i1)

- **Type**: `object`
- **Additional properties**: Any type allowed

### <a name="period-of-time--autogenerated_heading_3"></a>The following properties are required [#](#period-of-time--autogenerated_heading_3)
* endDate

## <a name="period-of-time--endDate"></a>`PeriodOfTime > endDate` [#](#period-of-time--endDate)
...
## <a name="period-of-time--@id"></a>`PeriodOfTime > @id` [#](#period-of-time--@id)
...
## <a name="period-of-time--@type"></a>`PeriodOfTime > @type` [#](#period-of-time--@type)
...
| [identifier](#location--identifier)           | null or [Identifier](/standards/catalog/dcat-us-3/identifiers-and-relationships/#identifier)                  | Optional          | The unique geographic identifier for the Location, e.g., the URI or other unique identifier in the context of the relevant gazetteer                             |
| [inScheme](#location--inScheme)               | null or [ConceptScheme](/standards/catalog/dcat-us-3/identifiers-and-relationships/#concept-scheme)           | Optional          | The gazetteer to which the location belongs                                                                                                                      |
...
## <a name="location--bbox"></a>`Location > bbox` [#](#location--bbox)
...
### <a name="location--bbox_anyOf_i0"></a>`Location > bbox > anyOf > item 0` [#](#location--bbox_anyOf_i0)

- **Type**: `null`

### <a name="location--bbox_anyOf_i1"></a>`Location > bbox > anyOf > item 1` [#](#location--bbox_anyOf_i1)

Bounding box represented in WKT, GeoJSON (stringified), or GML format

- **Type**: `string`

### <a name="location--bbox_anyOf_i2"></a>`Location > bbox > anyOf > item 2` [#](#location--bbox_anyOf_i2)
...
#### <a name="location--bbox_anyOf_i2_coordinates"></a>`Location > bbox > anyOf > item 2 > coordinates` [#](#location--bbox_anyOf_i2_coordinates)
...
#### <a name="location--bbox_anyOf_i2_type"></a>`Location > bbox > anyOf > item 2 > type` [#](#location--bbox_anyOf_i2_type)
...
## <a name="location--prefLabel"></a>`Location > prefLabel` [#](#location--prefLabel)
...
## <a name="location--@id"></a>`Location > @id` [#](#location--@id)
...
## <a name="location--@type"></a>`Location > @type` [#](#location--@type)
...
## <a name="location--centroid"></a>`Location > centroid` [#](#location--centroid)
...
### <a name="location--centroid_anyOf_i0"></a>`Location > centroid > anyOf > item 0` [#](#location--centroid_anyOf_i0)

- **Type**: `null`

### <a name="location--centroid_anyOf_i1"></a>`Location > centroid > anyOf > item 1` [#](#location--centroid_anyOf_i1)

Center point represented in WKT, GeoJSON (stringified), or GML format

- **Type**: `string`

### <a name="location--centroid_anyOf_i2"></a>`Location > centroid > anyOf > item 2` [#](#location--centroid_anyOf_i2)
...
#### <a name="location--centroid_anyOf_i2_coordinates"></a>`Location > centroid > anyOf > item 2 > coordinates` [#](#location--centroid_anyOf_i2_coordinates)
...
##### <a name="location--centroid_anyOf_i2_coordinates_items"></a>Array Item [#](#location--centroid_anyOf_i2_coordinates_items)

- **Type**: `number`

#### <a name="location--centroid_anyOf_i2_type"></a>`Location > centroid > anyOf > item 2 > type` [#](#location--centroid_anyOf_i2_type)
...
## <a name="location--geometry"></a>`Location > geometry` [#](#location--geometry)
...
### <a name="location--geometry_anyOf_i0"></a>`Location > geometry > anyOf > item 0` [#](#location--geometry_anyOf_i0)

- **Type**: `null`

### <a name="location--geometry_anyOf_i1"></a>`Location > geometry > anyOf > item 1` [#](#location--geometry_anyOf_i1)

String format of the full geometry of the location in WKT, GeoJSON, or GML format

- **Type**: `string`

### <a name="location--geometry_anyOf_i2"></a>`Location > geometry > anyOf > item 2` [#](#location--geometry_anyOf_i2)
...
#### <a name="location--autogenerated_heading_1"></a>The following properties are required [#](#location--autogenerated_heading_1)
* type
* coordinates

## <a name="location--identifier"></a>`Location > identifier` [#](#location--identifier)
...
## <a name="location--inScheme"></a>`Location > inScheme` [#](#location--inScheme)
...
## <a name="metric--expectedDataType"></a>`Metric > expectedDataType` [#](#metric--expectedDataType)
...
## <a name="metric--inDimension"></a>`Metric > inDimension` [#](#metric--inDimension)
...
## <a name="metric--definition"></a>`Metric > definition` [#](#metric--definition)
...
## <a name="metric--@id"></a>`Metric > @id` [#](#metric--@id)
...
## <a name="metric--@type"></a>`Metric > @type` [#](#metric--@type)
...
## <a name="quality-measurement--isMeasurementOf"></a>`QualityMeasurement > isMeasurementOf` [#](#quality-measurement--isMeasurementOf)
...
## <a name="quality-measurement--value"></a>`QualityMeasurement > value` [#](#quality-measurement--value)
...
## <a name="quality-measurement--@id"></a>`QualityMeasurement > @id` [#](#quality-measurement--@id)
...
## <a name="quality-measurement--@type"></a>`QualityMeasurement > @type` [#](#quality-measurement--@type)
...
## <a name="quality-measurement--unitMeasure"></a>`QualityMeasurement > unitMeasure` [#](#quality-measurement--unitMeasure)
...
## <a name="activity--label"></a>`Activity > label` [#](#activity--label)
...
## <a name="activity--@id"></a>`Activity > @id` [#](#activity--@id)
...
## <a name="activity--@type"></a>`Activity > @type` [#](#activity--@type)
...
## <a name="activity--category"></a>`Activity > category` [#](#activity--category)
...
## <a name="address--country-name"></a>`Address > country-name` [#](#address--country-name)
...
## <a name="address--locality"></a>`Address > locality` [#](#address--locality)
...
## <a name="address--postal-code"></a>`Address > postal-code` [#](#address--postal-code)
...
## <a name="address--region"></a>`Address > region` [#](#address--region)
...
## <a name="address--street-address"></a>`Address > street-address` [#](#address--street-address)
...
## <a name="address--@id"></a>`Address > @id` [#](#address--@id)
...
## <a name="address--@type"></a>`Address > @type` [#](#address--@type)
