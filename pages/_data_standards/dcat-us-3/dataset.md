...
| -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [contactPoint](#contactPoint)                           | single [Kind](/standards/catalog/dcat-us-3/agents/#kind) object or array of [Kind](/standards/catalog/dcat-us-3/agents/#kind) objects                                                     | Mandatory         | A contact point for questions about the Dataset (single contact or list). Include an email address that is continuously monitored                                                                                                                          |
| [description](#description)                             | string                                                                                                                                  | Mandatory         | Plain-language summary of the dataset                                                                                                                                                                                                                      |
| [identifier](#identifier)                               | string or [Identifier](/standards/catalog/dcat-us-3/identifiers-and-relationships/#identifier) object                                                            | Mandatory         | The unique identifier for the Dataset, e.g. the URI or other unique identifier in the context of the Catalog                                                                                                                                               |
...
| [spatial](#spatial)                                     | single [Location](/standards/catalog/dcat-us-3/temporal-spatial-metrics/#location) object or array of [Location](/standards/catalog/dcat-us-3/temporal-spatial-metrics/#location) objects | Recommended       | A geographic region or regions that are covered by the Dataset                                                                                                                                                                                             |
...
| [language](#language)                                   | single Language code or array of Language codes                                                                                         | Optional          | ISO 639-1 language code values used in the dataset text or metadata, such as en or es, full list can be seen at https://id.loc.gov/vocabulary/iso639-1.html                                                                                                |
...
- **Type**: single [Kind](/standards/catalog/dcat-us-3/agents/#kind) object or array of [Kind](/standards/catalog/dcat-us-3/agents/#kind) objects
- **Required**: Yes
- **Additional properties**: Any type allowed
...
- **Type**: single [Location](/standards/catalog/dcat-us-3/temporal-spatial-metrics/#location) object or array of [Location](/standards/catalog/dcat-us-3/temporal-spatial-metrics/#location) objects
- **Additional properties**: Any type allowed
