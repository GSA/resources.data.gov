...
**Authentication:** None required. This is a public, read-only API.
...
```bash
curl https://harvest.data.gov/harvest_sources/
```
...
```bash
curl https://harvest.data.gov/harvest_source/3fa85f64-5717-4562-b3fc-2c963f66afa6
```
...
```bash
curl https://harvest.data.gov/harvest_source/3fa85f64-5717-4562-b3fc-2c963f66afa6/jobs
```
...
```bash
curl https://harvest.data.gov/organizations/
```
...
```bash
curl https://harvest.data.gov/organization/f4ca4614-8901-409b-8553-2e994ad10023
```
...
```bash
curl https://harvest.data.gov/harvest_job/de2010f9-d9ec-4211-9690-5b3bbc9fe1f3
```
...
```bash
curl https://harvest.data.gov/harvest_job/de2010f9-d9ec-4211-9690-5b3bbc9fe1f3/errors
```
...
```bash
curl https://harvest.data.gov/harvest_record/d0e03fb2-f885-4b1d-8feb-2d8acc93f4f8
```
...
```bash
curl https://harvest.data.gov/harvest_record/d0e03fb2-f885-4b1d-8feb-2d8acc93f4f8/raw
```
...
```bash
curl https://harvest.data.gov/harvest_record/d0e03fb2-f885-4b1d-8feb-2d8acc93f4f8/transformed
```
...
```bash
curl -X POST https://harvest.data.gov/validate \
