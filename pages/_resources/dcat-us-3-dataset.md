...
| `publisher` | Required | object | The publishing entity and optionally its parent organization(s). References the [Agent class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#agent). |
| `contactPoint` | Required | object | Contact person's name and email for the dataset. References the [Kind class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#kind). |
...
| Field | Required | Type | Description |
|-------|----------|------|-------------|
| `distribution` | Conditional | array of objects | A container for one or more Distribution objects describing how the dataset can be accessed or downloaded. Required if the dataset has an `accessURL` or `downloadURL`. See [Distribution fields]({{ site.baseurl }}/resources/dcat-us-3/distribution/). |
...
| `rightsHolder` | Optional | object | An agent owning or managing rights over the dataset. References the [Agent class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#agent). |
| `license` | Optional | string (URL) | The license or public domain dedication status of the dataset. Provide as a URL. See [Open Licenses]({{ site.baseurl }}/resources/open-licenses/). |
...
| Field | Required | Type | Description |
|-------|----------|------|-------------|
| `spatial` | Conditional | object | Spatial coverage of the dataset. References the [Location class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#location). Required if the dataset has a spatial dimension. *(Was a string in v1.1; now uses the Location class)* |
| `temporal` | Conditional | object | Temporal coverage of the dataset. References the [PeriodOfTime class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#periodoftime). |
...
| `inSeries` | Optional | object | A DatasetSeries to which this dataset belongs. See [DatasetSeries fields]({{ site.baseurl }}/resources/dcat-us-3/dataset-series/). |
...
| `wasGeneratedBy` | Optional | array | Activities that generated this dataset. References the [Activity class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#activity). |
| `hasQualityMeasurement` | Optional | array | Quality measurements associated with the dataset. References the [QualityMeasurement class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#qualitymeasurement). |
...
| `qualifiedRelation` | Optional | array | A qualified relationship between this dataset and another resource. References the [Relationship class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#relationship). |
| `subject` | Optional | array | The topic or subject matter of the dataset. |
| `page` | Optional | array | Documentation pages for the dataset. References the [Document class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#document). |
...
| Field | Required | Type | Description |
|-------|----------|------|-------------|
| `creator` | Optional | array | The entity or entities that created the dataset. References the [Agent class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#agent). |
| `contributor` | Optional | array | Entities that contributed to the dataset. |
| `qualifiedAttribution` | Optional | array | A qualified attribution linking a dataset to an agent with a specific role. References the [Attribution class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#attribution). |
...
| `otherIdentifier` | Optional | array | Additional identifiers for the dataset beyond the primary identifier. References the [Identifier class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#identifier). |
| `supportedSchema` | Optional | object | A schema that the dataset conforms to. |
| `status` | Optional | object | The lifecycle status of the dataset. References the [Concept class]({{ site.baseurl }}/resources/dcat-us-3/supporting-classes/#concept). |
