...
details: >+
  ...
  **Required fields in v3.0:** None. However, each distribution should contain at least one of `accessURL` or `downloadURL`.
  ...
  <tr id="change-accessRestriction">
  ...
  <tr id="accessService">
  <td><code>accessService</code></td>
  <td>Optional</td>
  <td>array of DataService objects</td>
  <td>A data service that gives access to this distribution. Use this to link a distribution to a DataService record when the distribution is accessed through a service rather than a direct URL. References the <a href="../dcat-us-3-data-service/">DataService class</a>.</td>
  </tr>
  <tr id="availability">
  <td><code>availability</code></td>
  <td>Optional</td>
  <td>Concept object</td>
  <td>An indication of how long it is planned to keep this distribution available -- for example, "stable", "available", or "experimental". References the <a href="../dcat-us-3-supporting-classes/">Concept class</a>.</td>
  </tr>
  </tbody>
  </table>
  ...
  <td>Optional</td>
  <td>string</td>
  <td>A plain-language statement about whether this distribution is publicly accessible, restricted, or not public. Example: <code>"Public access without restrictions."</code></td>
  </tr>
  <tr id="language">
  ...
  <td>A unique identifier for this distribution, such as a DOI or ISBN. References the <a href="../dcat-us-3-supporting-classes/">Identifier class</a>.</td>
  </tr>
  <tr id="otherIdentifier">
  <td><code>otherIdentifier</code></td>
  <td>Optional</td>
  <td>array of Identifier objects</td>
  <td>Additional identifiers for the distribution beyond the main identifier. References the <a href="../dcat-us-3-supporting-classes/">Identifier class</a>.</td>
  </tr>
  <tr id="page">
  ...
  <td>Optional</td>
  <td>string (IRI)</td>
  <td>A thumbnail image illustrating the content of this distribution. Especially useful for visual data such as maps or photos. Provide as a URL.</td>
  </tr>
  <tr id="hasQualityMeasurement">
  <td><code>hasQualityMeasurement</code></td>
  <td>Optional</td>
  <td>array of QualityMeasurement objects</td>
  <td>Quality measurements for this distribution -- for example, completeness, accuracy, or timeliness. References the <a href="../dcat-us-3-supporting-classes/">QualityMeasurement class</a>.</td>
  </tr>
  </tbody>
  </table>
  ...
  <tr id="characterEncoding">
  <td><code>characterEncoding</code></td>
  <td>Optional</td>
  <td>array of strings</td>
  <td>The character encoding(s) of the distribution using IANA character set names. Example: <code>["UTF-8"]</code>.</td>
  </tr>
  ...
  <td>Minimum time period resolvable in this distribution. Example: <code>"P1D"</code> for daily resolution.</td>
  </tr>
  <tr id="compressFormat">
  ...
  | Date | Change |
  |---|---|
  | 2026-05-27 | Added missing fields: `accessService`, `availability`, `accessRights`, `identifier`, `otherIdentifier`, `hasQualityMeasurement`, `image`. Corrected `accessURL` requirement level from Conditional to Recommended and `downloadURL` from Conditional to Optional per schema reference. Added deep-link anchors to all table rows. Added link to full technical schema reference. |
