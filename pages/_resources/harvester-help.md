...
details: >-
  ...
  **An error does not mean your data is gone.** It means the metadata description of your dataset had a problem. Your actual data files are not affected.
  ...
  If after reading this guide you are still not sure what to do, forward the error CSV from the harvest job page to your data.gov point of contact. Include the name of your harvest source and the date of the failed job.
  ---
