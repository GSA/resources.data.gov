...
details: >+
  ...
  For the full technical schema reference, see the [DCAT-US 3.0 DataService schema source](https://github.com/GSA/dcat-us/blob/main/jsonschema/definitions/DataService.json).
  ...
  **Required fields in v3.0:** `endpointURL`, `contactPoint`, `publisher`, `title`
  ...
  | Date | Change |
  |---|---|
  | 2026-05-27 | Added deep-link anchors to all table rows. Added link to schema source on GitHub (no auto-generated schema reference page exists for DataService). |
